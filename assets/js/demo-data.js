...
window.EDC_DEMO = {
  ...
  siteSettings: {
    ...
    homepage_sections: [
      ...
      { id: "pagebuilder", label: "Page Builder Content", visible: true, order: 1 },
      { id: "services", label: "Why Schools & Teachers Choose EDC", visible: true, order: 2 },
      { id: "teachers", label: "Teaching Opportunities", visible: true, order: 3 },
      { id: "cta", label: "Ready to Teach in Thailand?", visible: true, order: 4 },
